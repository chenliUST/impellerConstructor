# Axisymmetric Throughflow Radial Bladed Impeller DSL v0.9 Changelog
...
1. Added V0.9 open and closed reference presets with the
   `validated_transition_bounded_brep` export contract.
2. Defines V0.9 as a kernel validity and reviewability milestone, not a new broad
...
6. Requires trim-exclusion-aware mesh and bounded review B-Rep export metadata so
   adjacent main faces do not hide transition defects.

## Limitations

- V0.9 exports a bounded, unsewn review B-Rep shell. It does not claim a watertight
  sewn solid.
