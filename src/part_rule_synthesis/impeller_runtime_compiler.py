...
IMPELLER_DSL_VERSIONS = ("v0_2", "v0_3", "v0_4", "v0_5", "v0_6", "v0_7", "v0_8", "v0_9", "v0_91")
...
def compile_impeller_runtime_preset(
    ...
    if dsl_version in {"0.7", "0.8", "0.9", "0.91"}:
...
def _selected_rules(
    ...
    if bundle.schema["dsl_version"] in {"0.4", "0.5", "0.6", "0.7", "0.8", "0.9", "0.91"}:
