...
export const presets = [
  ...
  {
    id: "ks007g23b-turbine-impeller",
    presetId: "ks007g23b_turbine_impeller_v1_1",
    geometryPatchVersion: "1.1.2",
    name: "KS007G23B turbine impeller V1.1.5",
    summary: "V1.1.5 engineering-drawing review runtime approximation of KS007G23B; unspecified blade freeform geometry is inferred because the referenced 3D model was not supplied.",
    tags: ["customer-drawing", "radial", "turbine", "13-blade", "review-grade", "v1.1.5"],
    metadata: v111Metadata(),
    editableParameters: [
      "mounting_bore_radius_mm",
      "blade_thickness_mm",
    ...
    loopFamilyDefaults: { main_blade_count: 13, splitter_blade_count: 0 },
    partFamilyId: "impeller",
    facets: {
      flow_topology: "radial",
      shroud_topology: "open",
      suction_topology: "single_suction",
      blade_exit_geometry: "backward_curved",
      working_domain: "turbine",
      passage_topology: "throughflow_bladed_channel",
    },
    synthesizeFacets: {},
    parameters: {
      blade_count: 13,
      inlet_radius_mm: 12.5,
      exit_radius_mm: 51.6,
      inlet_blade_height_mm: 6.5,
      outlet_blade_height_mm: 5.75,
      hub_curve_height_mm: 36.5,
      mounting_bore_radius_mm: 7.9,
      blade_wrap_deg: 82,
      blade_lean_deg: 8,
      leading_edge_lean_deg: 5,
      trailing_edge_lean_deg: -6,
      leading_edge_sweep_mm: 1.5,
      trailing_edge_sweep_mm: -1,
      blade_thickness_mm: 1.2,
      root_fillet_radius_mm: 0.8,
      leading_edge_radius_mm: 0.3,
      trailing_edge_radius_mm: 0.2,
      tip_edge_radius_mm: 0.25,
      hub_wall_thickness_mm: 2.5,
      hub_bottom_thickness_mm: 5.75,
      hub_top_cap_thickness_mm: 0.8,
      hub_chamfer_radius_mm: 0.3,
      hood_wall_thickness_mm: 1,
      hood_chamfer_radius_mm: 0.2,
    },
    profileOverrides: axialProfileOverrides(
      [[12.5, 36.5], [14, 33], [18, 26], [26, 16], [38, 6], [51.6, 0]],
      [[19, 36.5], [20.5, 34], [23.5, 29], [31.5, 22], [42.5, 13], [51.6, 5.75]],
    ),
    curveOverrides: axialCurveOverrides(
      [[0, 0], [0.22, -15], [0.55, -42], [0.8, -67], [1, -82]],
      [[0, 5], [0.35, 9], [0.7, 2], [1, -6]],
      boundedSweepCurve(1.5, 12.5, 51.6, [[0, -0.08], [0.5, 0], [1, 0.1]]),
      boundedSweepCurve(-1, 12.5, 51.6, [[0, 0.08], [0.5, 0], [1, -0.1]]),
      [[0, 1.2], [0.45, 1.0], [1, 0.65]],
    ),
  },
  {
    id: "ks007g23b-step-reconstructed-impeller",
    presetId: "ks007g23b_step_reconstructed_v1_1",
    geometryPatchVersion: "1.1.2",
    name: "KS007G23B STEP-reduced impeller V1.1.5",
    summary: "V1.1.5 review runtime reduction measured from the supplied STEP B-Rep; source topology and omitted manufacturing features remain explicit provenance.",
    tags: ["customer-step", "radial", "turbine", "13-blade", "review-grade", "v1.1.5"],
    metadata: v111Metadata(),
    editableParameters: [
      "mounting_bore_radius_mm",
      "blade_thickness_mm",
    ...
    parameters: {
      ...
      inlet_radius_mm: 12.5,
      exit_radius_mm: 51.6,
      inlet_blade_height_mm: 19.2,
      outlet_blade_height_mm: 5.4,
      hub_curve_height_mm: 25,
      mounting_bore_radius_mm: 7.9,
      blade_wrap_deg: 32,
      blade_lean_deg: 5.8,
      leading_edge_lean_deg: 2.7,
      trailing_edge_lean_deg: 0.7,
      leading_edge_sweep_mm: 0,
      trailing_edge_sweep_mm: 0,
      blade_thickness_mm: 5.2,
      root_fillet_radius_mm: 0.8,
      leading_edge_radius_mm: 0.3,
      trailing_edge_radius_mm: 0.2,
      tip_edge_radius_mm: 0.25,
    ...
    profileOverrides: axialProfileOverrides(
      [[12.5, 25], [16.1827, 15.6288], [22.752, 8.0011], [31.4809, 2.9762], [41.2849, 0.5809], [51.3767, 0]],
      [[31.7359, 25.0593], [32.9576, 19.1349], [35.8846, 13.8436], [40.2573, 9.6642], [45.6181, 6.8529], [51.5001, 5.3997]],
    ),
    curveOverrides: axialCurveOverrides(
      [[0, 0], [0.25, -8], [0.5, -18], [0.75, -27], [1, -32]],
      [[0, 2.7], [0.5, 5.8], [1, 0.7]],
      boundedSweepCurve(0, 12.5, 51.6, [[0, 0], [0.5, 0], [1, 0]]),
      boundedSweepCurve(0, 12.5, 51.6, [[0, 0], [0.5, 0], [1, 0]]),
      [[0, 0.9], [0.18, 5.8], [0.55, 6.2], [0.85, 5.0], [1, 0.3]],
    ),
  },
...
function presetDisplayRank(preset) {
  const preferredOrder = {
    ...
    ks007g23b_turbine_impeller_v1_1: 5,
    ks007g23b_step_reconstructed_v1_1: 6,
  };
