...
export const presets = [
  {
    ...
    summary: "Open impeller: V1.1.2 representative throughflow preset aligned with the backend main and splitter population contract.",
  ...
  },
  {
    ...
    summary: "Closed impeller: V1.1.2 representative throughflow preset aligned with the backend closed-loop population contract.",
  ...
  },
  {
    ...
    summary: "Representative public axial stator-ring approximation migrated to the V1.1.2 canonical blade-to-blade loop surface-family contract.",
  ...
  },
  {
    ...
    summary: "Representative public UltraFan CTi fan approximation migrated to the V1.1.2 canonical blade-to-blade loop surface-family contract.",
  ...
  },
  {
    ...
    summary: "Representative public liquid-rocket turbopump inducer approximation migrated to the V1.1.2 canonical blade-to-blade loop surface-family contract.",
